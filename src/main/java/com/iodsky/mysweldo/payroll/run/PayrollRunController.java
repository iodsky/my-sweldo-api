...
public class PayrollRunController {
    ...
    public ResponseEntity<ApiResponse<GeneratePayrollResponse>> generatePayroll(
    ...
    public ResponseEntity<ApiResponse<PayrollRunDto>> getPayrollRunById(
            @Parameter(description = "Payroll run ID") @PathVariable UUID id) {
    ...
    public ResponseEntity<ApiResponse<PayrollItemDto>> getPayrollItem(
            @Parameter(description = "Payroll run ID") @PathVariable UUID id,
    ...
    public ResponseEntity<ApiResponse<PayrollRunDto>> updatePayrollRunStatus(
            @Parameter(description = "Payroll run ID") @PathVariable UUID id,
    ...
    public ResponseEntity<ApiResponse<PayrollItemDto>> updatePayrollDeductions(
            @Parameter(description = "Payroll run ID") @PathVariable UUID id,
            @Parameter(description = "Payroll item ID") @PathVariable UUID itemId,
    ...
    public ResponseEntity<ApiResponse<PayrollItemDto>> updatePayrollBenefits(
            @Parameter(description = "Payroll run ID") @PathVariable UUID id,
            @Parameter(description = "Payroll item ID") @PathVariable UUID itemId,
    ...
    public ResponseEntity<ApiResponse<PayrollItemDto>> updatePayrollContributions(
            @Parameter(description = "Payroll run ID") @PathVariable UUID id,
            @Parameter(description = "Payroll item ID") @PathVariable UUID itemId,
    ...
    public ResponseEntity<ApiResponse<DeleteResponse>> deletePayrollItem(
            @Parameter(description = "Payroll run ID") @PathVariable UUID id,
            @Parameter(description = "Payroll item ID") @PathVariable UUID itemId) {
